...
// ***********************************************************************
// <copyright file="WeChatPay.cs" company="Heidelpay">
...
{
    /// <summary>
    /// Class WeChatPay. This class cannot be inherited.
    ...
    public sealed class WeChatPay : PaymentTypeBase, IChargeablePaymentType
    {
        /// <summary>
        ...
        public WeChatPay(IHeidelpay heidelpayClient)
