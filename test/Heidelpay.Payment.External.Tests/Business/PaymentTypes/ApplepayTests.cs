...
namespace Heidelpay.Payment.External.Tests.Business.PaymentTypes
{
    public class ApplepayTests : PaymentTypeTestsBase
    {
        private Action<Applepay> ConfigurePaymentType { get; } = new Action<Applepay>(x =>
        {
            ...
            {
                EphemeralPublicKey = "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEM/wYg/LmVp2e+TqXsUAIFlzK02Rwm9PAWiu6d3z+iQf8oLvqKUzf1OpjsJeGZfYriTIFe4H9EP6QWxMjoyIs5w==",
                PublicKeyHash = "M2yzlpBsH3GwH5jTV9GgKC7bAUdeIOIfjwQhoKjg5+s=",
                TransactionId = "d518ad5c087011e44149b4e74c6a7021ab24cf3d01887efde7694f6a04bda238",
            };
        });

        [Fact(Skip = "backend bug")]
